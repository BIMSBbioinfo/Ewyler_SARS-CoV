...
# ---------------------------------------------------------------------------- #
# uses louvain clustering on an embedding matrix
Cluster_Diffusion_Maps = function(
    lf_mat,
...
# Run diffusion map based knn clustering
dm_clust = Cluster_Diffusion_Maps(eigenvectors(dm_rna))
